...
$query = "SELECT return_table.id,item.item_name,return_table.quantity,return_table.date,employee.name FROM return_table JOIN item on item.item_id=return_table.item_id JOIN employee on return_table.employee_id=employee.id $sub_sql order by id desc";
?>
<head> 
    <style>
        .inputbox {
...
<div id="table">
  <h1 id="invisible" class="d-none"  >Return Report</h1>
  <table class="table ">
    <thread>
      <tr>
        <th>S/N</th>
